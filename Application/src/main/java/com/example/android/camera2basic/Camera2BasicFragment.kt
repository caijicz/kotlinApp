...
//                        CompareSizesByArea())
                imageReader = ImageReader.newInstance(1600, 1200,
...
//                        largest)
                ...
                if (resources.configuration.orientation == Configuration.ORIENTATION_LANDSCAPE) {
                    textureView.setAspectRatio(1600, 1200)
                } else {
                    textureView.setAspectRatio(1200, 1600)
                }
    ...
    private fun configureTransform(viewWidth: Int, viewHeight: Int) {
        ...
        val bufferRect = RectF(0f, 0f, 1200F, 1600F)
        ...
        if (Surface.ROTATION_90 == rotation || Surface.ROTATION_270 == rotation) {
            ...
            val scale = Math.max(
                    viewHeight.toFloat() / 1200F,
                    viewWidth.toFloat() / 1600F)
            with(matrix) {
    ...
    private fun lockFocus() {
        try {
            imageReader.apply {
                this?.setOnImageAvailableListener(onImageAvailableListener, backgroundHandler)
            }
